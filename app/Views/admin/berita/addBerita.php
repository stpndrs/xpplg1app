...
<div class="container" id="tambah-berita">

  <h1 class="yellow">Tambah Berita</h1>
  ...
  <form action="/admin/saveBerita" method="POST" enctype="multipart/form-data">
    ...
    <input class="form-control <?= ($validation->hasError('txtFile'))? 'is-invalid' : ''; ?>" type="file" id="formFile" name="txtFile" value="<?= old('txtFile'); ?>">
    <br>
    <div id="validationServer03Feedback" class="invalid-feedback">
      <?= $validation->getError('txtFile'); ?>
    </div>
    ...
    <input type="text" name="txtLink" placeholder="Link yang Terhubung...." class="<?= ($validation->hasError('txtLink'))? 'is-invalid' : ''; ?>" value="<?= old('txtLink'); ?>">
    <hr>
    <div id="validationServer03Feedback" class="invalid-feedback">
