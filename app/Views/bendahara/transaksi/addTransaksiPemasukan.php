...
<div class="container" id="tambah-transaksi">
  ...
  <h1 class="yellow">Tambah Transaksi Pemasukan</h1>

  <form action="/bendahara/saveTransPemasukan" method="POST" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    ...
    <input type="number" name="numJumlah" placeholder="Jumlah..." class="<?= ($validation->hasError('numJumlah')) ? 'is-invalid' : ''; ?>" value="<?= old('numJumlah'); ?>">
    <hr>
