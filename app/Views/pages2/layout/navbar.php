    <nav class="navbar navbar-expand-lg" data-aos="fade-down" data-aos-duration="1500" id="navbar">
        <div class="container">

            <a class="navbar-brand" href="#"><img src="<?= base_url(); ?>/imgassets/logo_nav.svg" alt="Intelligence Class"></a>
